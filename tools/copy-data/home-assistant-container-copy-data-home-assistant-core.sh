...
# bash -c "$(curl -fsSL https://raw.githubusercontent.com/Dunky13/ProxmoxVE/refs/heads/feature/wishlistmain/tools/copy-data//home-assistant-container-copy-data-home-assistant-core.sh)"
